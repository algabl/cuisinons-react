...
DB_PASSWORD=$(echo "$NEON_DATABASE_URL" | awk -F':' '{print $3}' | awk -F'@' '{print $1}')
DB_PORT=$(echo "$NEON_DATABASE_URL" | awk -F':' '{print $4}' | awk -F'\/' '{print $1}')
DB_NAME=$(echo "$NEON_DATABASE_URL" | awk -F'/' '{print $4}')
